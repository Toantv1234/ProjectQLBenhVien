...
{
    public partial class ThongKeDieuTri : Form
    {
        public static QLCuocHenNS instance;
        SqlConnection _connection = null;
        SqlCommand _command = null;
        String _connectionString = "";
        public ThongKeDieuTri()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                string proc = "p_ViewDieuTriTimeRange";
        ...
        private void ThongKeDieuTri_Load(object sender, EventArgs e)
        {
